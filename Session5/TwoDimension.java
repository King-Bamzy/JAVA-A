package Session5;
// package session5; // Assuming the package declaration
public class TwoDimension {
    ...
    public void storeMarks() {
        // Instantiate the array: [4] rows, [2] columns
        marks = new int[4][2]; // line 2
        System.out.println("Storing Marks. Please wait...");
        
        // Initialize array elements (e.g., marks for 4 students, 2 subjects)
        marks[0][0] = 23;
        marks[0][1] = 65;
    ...
    public static void main(String[] args) {
        ...
        TwoDimension twoDimObj = new TwoDimension(); // line 4
        
        // Invoke the storeMarks() method
        twoDimObj.storeMarks();
        
        // Invoke the displayMarks() method
        twoDimObj.displayMarks();
    }
}
